...
DEFINITIONS = [
    ...
    ("tax.default.mode", "Tax calculation mode", "TENANT BUSINESS POLICY",
     "enum", "exclusive", None, None, "exclusive,inclusive", "platform,tenant,branch", 1, "high"),
    ("tax.default.type", "Tax type", "TENANT BUSINESS POLICY",
     "enum", "standard", None, None, "standard,zero_rated,exempt", "platform,tenant,branch", 1, "high"),
    ("tax.withholding.rate", "Withholding tax rate %", "TENANT BUSINESS POLICY",
     "percent", "0", 0, 100, None, "platform,tenant,branch", 1, "high"),
